...
export const app_policy = [
  {
    ...
    name: "APP POLICY",
    detail:
      "Thank you for using our social networking mobile app. This App Policy sets out the terms and conditions governing your use of our app. By accessing or using our app, you agree to be bound by this policy \n 1. Privacy Policy: Our app collects and uses your personal information in accordance with our Privacy Policy. By using our app, you agree to the collection and use of your personal information as described in our Privacy Policy. \n 2. User Content: Our app allows you to post content such as photos, videos, and text. You are solely responsible for the content that you post on our app. By posting content on our app, you represent and warrant that you own or have the necessary licenses, rights, consents, and permissions to use and authorize us to use your content. \n 3. Prohibited Activities: You agree not to engage in any activities that are prohibited by law or violate our community standards. Prohibited activities include, but are not limited to, posting content that is defamatory, obscene, or offensive, harassing other users, and violating the intellectual property rights of others. \n 4. Termination: We may terminate your access to our app at any time without notice or liability. Upon termination, you must immediately delete our app from your device. \n 5. Changes to App Policy: We reserve the right to modify this App Policy at any time. We will notify you of any changes by posting the updated policy on our app. Your continued use of our app after the updated policy has been posted constitutes your acceptance of the changes.",
  },
  {
    id: uuid.v4(),
    name: "TERMS AND CONDITIONS",
    detail:
      "Welcome to our social networking mobile app. These Terms and Conditions set out the terms and conditions governing your use of our app. By accessing or using our app, you agree to be bound by these Terms and Conditions. 1. License: We grant you a non-exclusive, non-transferable, revocable license to use our app for personal, non-commercial purposes only. You may not copy, modify, distribute, sell, or transfer any part of our app without our prior written consent. 2. User Content: Our app allows you to post content such as photos, videos, and text. You are solely responsible for the content that you post on our app. By posting content on our app, you represent and warrant that you own or have the necessary licenses, rights, consents, and permissions to use and authorize us to use your content. 3. Prohibited Activities: You agree not to engage in any activities that are prohibited by law or violate our community standards. Prohibited activities include, but are not limited to, posting content that is defamatory, obscene, or offensive, harassing other users, and violating the intellectual property rights of others. 4. Intellectual Property: All intellectual property rights in our app, including but not limited to copyright, trademarks, and trade secrets, are owned by us or our licensors. You may not use our intellectual property without our prior written consent. 5. Disclaimers: Our app is provided 'as is' and without warranty of any kind, either express or implied, including but not limited to, the implied warranties of merchantability, fitness for a particular purpose, or non-infringement. We do not warrant that our app will be uninterrupted or error-free, that defects will be corrected, or that our app or the servers that make it available are free of viruses or other harmful components. 6. Limitation of Liability: We will not be liable to you or any third party for any indirect, special, incidental, consequential, or punitive damages arising out of or relating to your use of our app, even if we have been advised of the possibility of such damages. Our liability to you or any third party shall in no event exceed the total amount paid by you to us.",
  },
];
